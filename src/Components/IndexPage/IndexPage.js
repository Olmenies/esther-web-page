...
const IndexPage = () => {
  ...
  return(
    <div>
      <Carousel/>
      <div className='container indexMainContainer'>
        <div className='row justify-content-center'>
          <div className='col-md-10'>
            <h3 className='indexMainTitle'>HECHO A MEDIDA</h3>
            <div className='container'>

              <div className='row'>
                <div className='col-md-12 indexMainDescription'>
              ...
              <div className='row indexMainRow'>
                <div className='col-md-6 indexMainColumns'>
